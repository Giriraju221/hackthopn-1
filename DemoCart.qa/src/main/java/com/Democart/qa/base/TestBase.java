...
public class TestBase {
	...
	public TestBase() {
		try {
			...
			FileInputStream fis = new FileInputStream("C:\\Users\\jgk\\Downloads\\DemoCart.qa\\config\\config.properties");
			prop.load(fis);
	...
	//C:\\Users\\jgk\\Downloads\\chromedriver_win32\\chromedriver.exe
	public static void initialization() {
		String browserName = prop.getProperty("browser");
		if (browserName.equals("chrome")) {
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\jgk\\Downloads\\chromedriver1.exe");  //Chrome browser
